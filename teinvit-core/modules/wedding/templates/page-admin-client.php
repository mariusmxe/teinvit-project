...
@media (max-width: 768px){.teinvit-admin-page{padding:10px}.teinvit-two-col{display:block!important}.teinvit-two-col>div{width:100%!important;max-width:100%!important;min-width:0}.teinvit-admin-page .teinvit-preview{display:block!important;visibility:visible!important;opacity:1!important;max-width:100%!important;min-height:280px;overflow:hidden}.teinvit-admin-preview-block{display:block!important;order:1;min-width:0}.teinvit-admin-page .teinvit-preview img,.teinvit-admin-page .teinvit-preview svg,.teinvit-admin-page .teinvit-preview canvas{max-width:100%!important;height:auto!important}.teinvit-report-grid{grid-template-columns:1fr}.teinvit-report-card{overflow-wrap:normal;word-break:normal}.teinvit-report-card strong{display:block;margin-bottom:4px;word-break:normal;overflow-wrap:normal;hyphens:none}}
