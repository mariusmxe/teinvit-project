...
<script>
(function(){
  document.body.classList.add('teinvit-admin-client-birthday');
  const birthdayAdminRoot = document.querySelector('.teinvit-admin-page-birthday');
  const birthdayAstContainer = birthdayAdminRoot && birthdayAdminRoot.closest ? birthdayAdminRoot.closest('.ast-container') : null;
  if (birthdayAstContainer) birthdayAstContainer.classList.add('teinvit-admin-client-container-birthday');
