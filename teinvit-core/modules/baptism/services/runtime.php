...
function teinvit_baptism_renderer( array $context = [] ) {
    ...
    if ( ! $assets_loaded ) {
        ...
        $theme_css_url = add_query_arg( 'ver', rawurlencode( $asset_ver ), TEINVIT_BAPTISM_MODULE_URL . 'preview/themes.css' );
    ...
    if ( ! $is_pdf ) {
        ...
        if ( ! $is_product_page ) {
            ...
            $preview_js_url = add_query_arg( 'ver', rawurlencode( $asset_ver ), TEINVIT_BAPTISM_MODULE_URL . 'preview/preview.js' );
